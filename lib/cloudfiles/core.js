...
// file name
// meta object
Cloudfiles.prototype.updateFileMeta = function( container, file, meta, callback ){

  if( typeof meta !== 'object' ){ return callback( new Error('No data is not provided for meta') ) } 
